    ...
    + dharitri_sc_modules::default_issue_callbacks::DefaultIssueCallbacksModule
{
    ...
    fn add_lp_to_whitelist(
        ...
        require!(
            first_token_id.is_valid_dcdt_identifier() && second_token_id.is_valid_dcdt_identifier(),
            "Only DCDT tokens accepted"
        );
        require!(
    ...
    fn unlock_lp_payments(
        &self,
        first_payment: DcdtTokenPayment<Self::Api>,
        second_payment: DcdtTokenPayment<Self::Api>,
    ) -> (
    ...
    fn unlock_single_payment(
        ...
        if payment.token_identifier == locked_token_id {
            ...
            let unlocked_payment = DcdtTokenPayment::new(
                attributes.original_token_id.unwrap_dcdt(),
